...
The data presented are a subset of those used in Weller et al. (2024) and Murphy et al (2025). **Table 1 in Weller et al. (2024)** and **Table 1 in Murphy et al (2025)** list all datasets used by said publication including appropriate citations. Datasets are included here only if the data owners gave permission for the data to be shared or if the data were already publicly available. Public datasets are included only when they were difficult to locate, or when additional variables were derived or extracted for use in the studies (e.g., land use, weather, or methods variables). 
...
## Citations
If you download and use a given dataset, please cite:
1. the original data source(s);
2. Weller at al. (2024);
3. Murphy et al (2025) if the dataset includes microbial source tracking data;
4. this GitHub.
Additionally, if the dataset was generated by a citizen science organization please cite the **citizen science website** (e.g., https://www.communityscience.org/) as well. Additionally, if the dataset was **available online** AND was **described in a peer-review paper** (e.g., https://doi.org/10.1093/jambio/lxad210) please cite the peer-review paper as well (e.g., Weller et al. 2022). The citation for the original data source and websites can be found by linking the dataset name (e.g., CSI, DUCK, LW) with Table 1 in Weller at al. (2024) or Murphy et al (2025).
